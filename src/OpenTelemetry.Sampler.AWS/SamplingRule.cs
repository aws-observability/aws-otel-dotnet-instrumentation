...
internal class SamplingRule : IComparable<SamplingRule>
{
    ...
    [JsonPropertyName("SamplingRateBoost")]
    public SamplingRateBoost? SamplingRateBoost { get; set; }

    public bool HasBoost() => this.SamplingRateBoost != null;

    public bool IsDefaultAnomalyDetectionDisabled() =>
        this.SamplingRateBoost != null && this.SamplingRateBoost.DisableDefaultAnomalyDetection;
