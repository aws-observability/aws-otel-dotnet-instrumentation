...
// Phase-2 line-probe PoC (AWS Distro DI). Additive export — mirrors AddInstrumentations shim.
EXTERN_C VOID STDAPICALLTYPE AddLineProbes(WCHAR* id, trace::LineProbeDefinition* items, int size)
{
